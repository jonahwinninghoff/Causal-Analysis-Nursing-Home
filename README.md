...
- <p align = 'justify'>The CMS pilot program is established by either helping to provide financial aid for LPN-to-RN career pathway or promote awareness of existing programs. The randomized controlled trials (RCT) should be in use to identify real impacts either approaches have on health inspection rating over time. </p>
